...
def scrape_movie_details():
    ...
    poster=soup.find('div',class_='ipc-poster')
    poster1='https://www.imdb.com'+poster
    details_dict['poter_image_url']=poster1
    
    bio_data=soup.find('span',class_='GenresAndPlot__TextContainerBreakpoinytXL-cum89-2 gCtawA').text
    details_dict['bio']=bio_data
    movie_name=soup.find('div',class_='TitleBlock_Container-sc-InlRHk').h1.text
